...
\ \ \ \ The false positive rate (FPR) is the proportion of tests that detected a positive result when there was no true effect present. In our simulation, a false positive correponds to a significant finding given an underlying true effect smaller than 0.5 or 1.0, respectively. 

### False negative rate across trajectory

\ \ \ \ The false negative rate (FNR) is the proportion of tests that missed a true positive relationship. In our simulation, this correponds to non-significant results given that the underlying true effect was greater or equal to 0.5 or 1.0, respectively. 
