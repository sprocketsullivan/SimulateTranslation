...
Overall, our simulation shows that current practice reflected by the standard trajectory does not meet the complementary goals of exploration and confirmation along the preclinical research trajectory. In the standard trajectory, the switch from exploratory to confirmatory mode is extremely costly, as it eliminates numerous potentially meaningful effects. This shortcoming is also reflected in the PPV where even in the best-case scenario only 40 out 100 significant results reflect an underlying true effect (compared to 73/100 in the SESOI trajectory). In light of our findings, we advise a rejection of the standard approach. We present here an easily applicable alternative to current practice. Optimizing decision criteria and sample size calculations by employing a SESOI increases chances to detect true effects.
