...
# setwd("~/Documents/QUEST/PhD/R/SimulateTranslation/data/Carneiro_distribution/Bayes_factor_analysis")
# 
# list_filenames <- list.files(pattern ="*_1.0_BF10")
# list_filenames
# 
# list_data <- list()
# 
...
out1 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_equiv_method1_1.0_BF10")
out2 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_equiv_method2_1.0_BF10")
out3 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.05_method1_1.0_BF10")
out4 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.05_method2_1.0_BF10")
out5 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.1_method1_1.0_BF10")
out6 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.1_method2_1.0_BF10")

levels(out5$decision_crit) <- c(levels(out5$decision_crit), "significance_0.1")
out5$decision_crit[out5$decision_crit == 'significance'] <- 'significance_0.1'

levels(out6$decision_crit) <- c(levels(out6$decision_crit), "significance_0.1")
out6$decision_crit[out6$decision_crit == 'significance'] <- 'significance_0.1'

outcomes1 <- bind_rows(out1, out2, out3, out4, out5, out6)
outcomes1$SESOI <- 1.0

out7 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_equiv_method1_0.5_BF10")
out8 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_equiv_method2_0.5_BF10")
out9 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.05_method1_0.5_BF10")
out10 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.05_method2_0.5_BF10")
out11 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.1_method1_0.5_BF10")
out12 <- read.csv(file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_sig_p0.1_method2_0.5_BF10")

levels(out11$decision_crit) <- c(levels(out11$decision_crit), "significance_0.1")
out11$decision_crit[out11$decision_crit == 'significance'] <- 'significance_0.1'

levels(out12$decision_crit) <- c(levels(out12$decision_crit), "significance_0.1")
out12$decision_crit[out12$decision_crit == 'significance'] <- 'significance_0.1'

outcomes2 <- bind_rows(out7, out8, out9, out10, out11, out12)
outcomes2$SESOI <- 0.5


outcomes <- bind_rows(outcomes1, outcomes2)

# write.csv(outcomes, file = "./data/Carneiro_distribution/Bayes_factor_analysis/outcomes_all_SESOI_BF10")
...
# ggsave("./plots/Bayes_factor_analysis/Carneiro_PPV_across_trajectory_BF3.svg")


plot_FPR <-
  ggplot(data = plot_data, 
         aes(x = factor(trajectory), y = FPR, color = factor(SESOI))) +
  geom_point(size = 4, alpha = .8) +
  # facet_wrap(~ SESOI, labeller = as_labeller(facet_names)) +
  # facet_grid(SESOI ~ distribution, labeller = labeller(.rows = facet_names)) +
