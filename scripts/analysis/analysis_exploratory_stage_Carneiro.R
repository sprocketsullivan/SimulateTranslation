...
# save(exploratory_data_Carneiro_10, file = "./data/exploratory_data_SESOI_Carneiro_10.RData")

ggplot(data = exploratory_data_Carneiro_10,
       aes(x = ES_true, 
...
extractor2 <- function(k) {
  ...
  test_data_sig <- read_csv(paste("./data/Carneiro_distribution/Frequentist_analysis/exploratory_stage_sig_", k, sep = ""))
}
...
# save(exploratory_data_sig_Carneiro_10, file = "./data/exploratory_data_significance_Carneiro_10.RData")
